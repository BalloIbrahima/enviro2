...
class Items extends API {
	...
	public function get_items( WP_REST_Request $request ) {
		...
		$query = 'total_page, current_page, data { id, name, price, rating, downloads, type, slug, favourite_count, thumbnail, thumbnail2, thumbnail3 }';
		if( $type !== 'packs' ) {
			$query = 'total_page, current_page, data { id, name, price, rating, downloads, type, slug, favourite_count, dependencies{ id, name, icon, plugin_file, plugin_original_slug, is_pro, link }, thumbnail }';
		}
